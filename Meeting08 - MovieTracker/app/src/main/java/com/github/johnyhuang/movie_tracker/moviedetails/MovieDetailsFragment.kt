...
import com.github.johnyhuang.movie_tracker.R
import com.github.johnyhuang.movie_tracker.database.MovieDatabase
import com.github.johnyhuang.movie_tracker.databinding.FragmentMovieDetailsBinding
    ...
    override fun onCreateView(
        ...
        movieDetailsViewModel.navigateToMovieTracker.observe(this, Observer {status ->
            when (status) {
                ...
                "emptyMovieName" -> Toast.makeText(this.context, "Movie Title is empty.", Toast.LENGTH_SHORT).show()
                "emptyRating" -> Toast.makeText(this.context, "Movie Rating is empty.", Toast.LENGTH_SHORT).show()
            }
        })
